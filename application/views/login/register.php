  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="<?=base_url('login/login')?>">Iniciar Sesion</a>
            </li>
            </ul>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card" style="margin-top: 30px">
                    ...
                    <div class="card-body">
                        <form method="post" autocomplete="off" action="<?=base_url('login/register/')?>">
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Nombre</label>
                                <input type="text" placeholder="Nombre de usuario" name="username" class="form-control" id="name" aria-describedby="name">
                            </div>
                            <div class="mb-3">
